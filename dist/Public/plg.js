...
(function ($, async) {
    ...
    var isLoggedIn = (typeof unsafeWindow.g_rgWalletInfo !== "undefined" &&
    ...
    var market = new SteamMarket(unsafeWindow.g_rgAppContextData, typeof unsafeWindow.g_strInventoryLoadURL !== "undefined" &&
        unsafeWindow.g_strInventoryLoadURL != null
        ? unsafeWindow.g_strInventoryLoadURL
        : location.protocol + "//steamcommunity.com/my/inventory/json/", isLoggedIn ? unsafeWindow.g_rgWalletInfo : undefined);
    var currencyId = isLoggedIn &&
        market != null &&
    ...
    if (currentPage == PAGE_MARKET || currentPage == PAGE_MARKET_LISTING) {
        ...
        function getPriceFromMarketListing(listing) {
            ...
            if (priceLabel[priceLabel.length - 1] === "." ||
        ...
        function marketListingsQueueWorker(listing, ignoreErrors, callback) {
            ...
            market.getPriceHistory(item, true, function (errorPriceHistory, history, cachedHistory) {
                ...
                market.getItemOrdersHistogram(item, true, function (errorHistogram, histogram, cachedListings) {
                    ...
                    $(".market_table_value > span:nth-child(1) > span:nth-child(1) > span:nth-child(1)", listingUI).append(' ➤ <span  title="This is likely the highest buy order price.">' +
                    ...
                    $(".market_listing_my_price", listingUI)
                        .last()
                        .append('<span id="my_market_sellistings_total_price">, ' +
        ...
        marketListingsItemsQueue.drain = function () {
            ...
            $(".market_listing_row", myMarketListings).each(function () {
                ...
                if ($(".item_market_action_button", this)
                    .attr("href")
                    .toLowerCase()
        ...
        function fillMarketListingsQueue() {
            $(".market_home_listing_table").each(function (e) {
                ...
                if (!$(this).attr("id")) {
                    ...
                    $(this).append('<div class="market_listing_see" id="market-listing-container-' +
                        e +
                        '"></div>');
            ...
            $("#my_market_selllistings_number").append('<span id="my_market_sellistings_total_price">, ' +
        ...
        function processMarketListings() {
            ...
            var currentCount = 0;
            var totalCount = 0;
            if (typeof unsafeWindow.g_oMyListings !== "undefined" &&
